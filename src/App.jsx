 ...
 recognition.onend = () =>setIsListening(false)
  ...
  const handleVoiceCommand = async (command) =>{
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'm siri, Your voice assistant created by Mr. Raj Gupta";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello siri")) {
      const response = "Hello Sir I'm siri, How can i help you";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("what is your age")) {
      const response = "Hello Sir I'm siri, I'm 20 years day old";
      speakText(response);
      setInformation(response);
      return;
    }
